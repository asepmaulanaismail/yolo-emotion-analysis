...
def plot_one_box(x, im, color=None, label=None, line_thickness=3, kpt_label=False, kpts=None, steps=2, orig_shape=None, font_scale=1.5):
    ...
    if label:
        ...
        cv2.putText(im, label, (c1[0], c1[1] - 2), 0, font_scale, [225, 255, 255], thickness=tf//2, lineType=cv2.LINE_AA)
    if kpt_label:
